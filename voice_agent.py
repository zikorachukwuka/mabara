...
async def main():
    ...
    options = state.ClaudeAgentOptions(
        ...
        system_prompt=(
            ...
            "propose_plan came back approved, and only for big plans of "
            "four or more files or a long grind; pass it the full plan "
            "text and the context it needs, tell the user you're handing "
            "execution to the worker, and when it reports back, verify "
            "and speak the summary yourself. Execute smaller plans "
            "yourself. Never launch any other agent type. And launches "
